...
**Note:** Version 28 of OBS does not seem to be compatible with the Spout2 OBS plugin v1.3 anymore. If you are using Spout2 with OBS, hold off on updates until the plugin is updated.

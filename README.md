...
<a href="https://github.com/emilianavt/VSeeFaceReleases/releases/download/v1.13.34f/VSeeFace-v1.13.34f.zip" class="download">Download<br>v1.13.34f</a>
...
* Load your model into Waidayo by naming it default.vrm and putting it into the Waidayo app's folder on the phone or transfer it using [this](https://booth.pm/ja/items/2535168) application (I'm not sure, if you have more clear instructions I can put here, please let me know)
